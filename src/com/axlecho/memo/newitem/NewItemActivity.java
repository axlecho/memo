...
public class NewItemActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		popupAddView = getLayoutInflater().inflate(R.layout.menu_add, null,
				true);
		popupAdd = new PopupWindow(popupAddView, LayoutParams.FILL_PARENT,
		...
		editAddTextView = (EditText) popupAddView
				.findViewById(R.id.view_addnote);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == Const.CAMERARESULT) {
			cm.setBgPic(Environment.getExternalStorageDirectory()
					+ "/workupload.jpg");
		}
	}
	...
	private void insertRecord() throws IOException {
		...
		String picPath = Environment.getExternalStorageDirectory().getPath()
				+ "/Memo/" + "memo_pic_data" + System.currentTimeMillis()
				+ ".png";
		String voicePath = "";
